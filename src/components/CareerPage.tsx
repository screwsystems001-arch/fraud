    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
                Build Your Career <span className="text-blue-800">With Us</span>.
                <br />
                    ...
                    <div className="flex items-center justify-center h-64">
                      <div className="text-center">
                        <div className="relative inline-block">
                          <Briefcase className="w-24 h-24 text-blue-800 mx-auto mb-4 animate-float" />
                          <div className="absolute inset-0 bg-blue-200 rounded-full blur-xl opacity-50 animate-pulse"></div>
                        </div>
                        <h3 className="text-xl font-bold text-gray-900 mb-2">Join Our Team</h3>
                        <p className="text-gray-600">Build your career with experienced professionals and industry experts in engineering development and consulting.</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  ...
                  <div className="md:ml-4">
                    <a 
                      ...
                      className="group bg-blue-800 hover:bg-blue-900 text-white px-6 py-3 rounded-xl font-semibold transition-colors duration-200 flex items-center whitespace-nowrap inline-block"
                    >
                      Apply Now
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-bold text-gray-900 mb-2">Browse Positions</h3>
                <p className="text-gray-600 text-sm">Explore our open positions and find the role that matches your skills</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Click "Apply Now" and send us your resume with a cover letter</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Our team will review and contact you for the next steps</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-800 to-blue-900">
        <div className="container mx-auto px-6 text-center">
          ...
          <a 
            href="mailto:screwsystems001@gmail.com?subject=General Application"
            className="inline-flex items-center bg-white hover:bg-blue-50 text-blue-800 px-8 py-4 rounded-xl font-bold text-lg transition-colors duration-200 hover:shadow-lg"
          >
            Send Your Resume
